...
(function() {
  baoxiao.Votes = {
    updateVote: function(id, voted) {
      if (voted == null) {
        voted = true;
      }
      if (voted) {
        return $("#vote-for-joke-" + id + " a.voteJoke").addClass('disabled');
      }
    },
    updateVotes: function(ids, voted) {
      ...
      for (_i = 0, _len = ids.length; _i < _len; _i++) {
        id = ids[_i];
        _results.push(this.updateVote(id, voted));
      }
      return _results;
    }
  };
...
(function() {
  baoxiao.AD = {
    init: function() {
      ...
      $ad = $('.group-ads');
      if ($ad.length > 0) {
        return this.floatingSideBarAd($ad);
      }
    },
    floatingSideBarAd: function($ad) {
      var ad_h, ad_top, ad_w, fixAd, footer_top;
      footer_top = $('.footer').offset().top;
      ad_h = $ad.height();
      ad_w = $ad.width();
      ad_top = $ad.offset().top;
      fixAd = function() {
        var left_h, right_bar_h;
        left_h = $('body').is('.jokes-show') ? left_h = $('.col-md-8').height() - 20 : $('.jokes').height();
        right_bar_h = $('.col-md-4').height();
        if (left_h <= right_bar_h) {
          return;
        }
      ...
      return $('.col-md-8').imagesLoaded(function() {
        return fixAd();
      });
    }
  };
...
(function() {
  ...
  $(document).ready(function() {
    ...
    $('[data-toggle=dropdown]').each(function() {
      var func;
      func = function() {};
      return this.addEventListener('click', func, false);
    });
    $('a.voteJoke').click(function() {
      var anonymous_votes, count, url;
      if ($(this).is('.disabled')) {
        return false;
      }
      ...
      url = $(this).data('href');
      $.post(url, {
        vote_value: $(this).data('vote_value')
      });
      ...
      if (!baoxiao.currentUser) {
        ...
        return $.cookie('anonymous_votes', anonymous_votes, {
          path: '/'
        });
      }
    });
    $('.site-top a.feed').click(function() {
      return $('#qq-feed').modal();
    });
